...
\begin{itemize}
\item The simple example: \href{http://mery54.github.io/fmt/models/cont-simple.zip}{link
    for  \textsf{Event-B} model cont-simple.zip}
  \item The maximum of two  integers: \href{http://mery54.github.io/fmt/models/cont-max2.zip}{link
      for  \textsf{Event-B} model cont-max2.zip}
      \item The maximum of a list of integers: \href{http://mery54.github.io/fmt/models/cont-maximum.zip}{link
    for  \textsf{Event-B} model cont-maximumzip} 
\end{itemize}
